...
function loadFollowedPosts() {
    ...
    fetch('/api/followed_posts')
        ...
        .then(posts => {
            ...
            // This ensures that event delegation works for dynamically added content
            setTimeout(() => {
                // Force re-initialization of event listeners
                const toggleCodeBtns = document.querySelectorAll('.toggle-code-btn');
                const copyTikzBtns = document.querySelectorAll('.copy-tikz-btn');
